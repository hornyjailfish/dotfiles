-- i am not sure how to use it properly there are too much stuff like different stacks
...
return {
	...
	opts = {
		...
		trail_options = {
			...
			current_trail_mark_mode = "buffer_local_chron",
			current_trail_mark_list_type = "quickfix", -- currently only quickfix lists are supported
			trail_mark_list_rows = 5, -- number of rows to show in the trail mark list
